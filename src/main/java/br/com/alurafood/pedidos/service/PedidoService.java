...
public class PedidoService {
    ...
    public PedidoDto atualizaStatus(Long id, StatusDto statusDto) {
        Pedido pedido = repository.porIdComItens(id);

        if (pedido == null) throw entityNotFoundException();

        pedido.setStatus(statusDto.getStatus());
        repository.atualizaStatus(statusDto.getStatus(), pedido);
    ...
    private ResponseStatusException entityNotFoundException(){
